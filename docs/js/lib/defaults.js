...
export const DEFAULT_SHOOTER_DX = {
  ...
  stages: [
    ...
    // ---- 第6〜10面：第5面から少しずつ強くする（敵の速さ・数・弾の量と速さ・ボスの体力） ----
    {
      name: '深海の神殿', bgTheme: 'ocean',
      enemySpeed: 172, spawnMs: 440,
      enemyFireMs: 800, enemyFireCount: 3, enemyBulletSpeed: 250,
      enemyMix: [
        { type: 'normal', weight: 1 },
        { type: 'tough', weight: 2 },
        { type: 'swift', weight: 2 },
        { type: 'gunner', weight: 3 },
        { type: 'charger', weight: 2 },
        { type: 'splitter', weight: 3 },
        { type: 'shielded', weight: 2 },
        { type: 'mine', weight: 2 },
        { type: 'formation', weight: 1 },
      ],
      duration: 120000, clearScore: 22000,
      midboss: { name: '海の番兵', hp: 190 },
      boss: { name: '深海の大王イカ', pattern: 'squid', hp: 820, fireMs: 1100, speed: 90, ways: 8 },
    },
    {
      name: '氷の城', bgTheme: 'ice',
      enemySpeed: 180, spawnMs: 420,
      enemyFireMs: 760, enemyFireCount: 3, enemyBulletSpeed: 255,
      enemyMix: [
        { type: 'normal', weight: 1 },
        { type: 'tough', weight: 2 },
        { type: 'swift', weight: 3 },
      ...
      duration: 126000, clearScore: 24000,
      midboss: { name: '氷の番兵', hp: 220 },
      boss: { name: '氷の女王', pattern: 'ice', hp: 940, fireMs: 900, speed: 120, ways: 5 },
    },
    {
      name: '灼熱の砂漠', bgTheme: 'desert',
      enemySpeed: 188, spawnMs: 400,
      enemyFireMs: 720, enemyFireCount: 4, enemyBulletSpeed: 260,
      enemyMix: [
        { type: 'normal', weight: 1 },
        { type: 'tough', weight: 3 },
        { type: 'swift', weight: 2 },
        { type: 'gunner', weight: 3 },
        { type: 'charger', weight: 3 },
        { type: 'splitter', weight: 2 },
        { type: 'shielded', weight: 2 },
        { type: 'mine', weight: 3 },
        { type: 'formation', weight: 1 },
      ],
      duration: 126000, clearScore: 26000,
      midboss: { name: '砂の番兵', hp: 250 },
      boss: { name: '砂漠の大サソリ', pattern: 'scorpion', hp: 1060, fireMs: 800, speed: 150, ways: 3 },
    },
    {
      name: '暗黒星雲', bgTheme: 'nebula',
      enemySpeed: 196, spawnMs: 380,
      enemyFireMs: 680, enemyFireCount: 4, enemyBulletSpeed: 265,
      enemyMix: [
        { type: 'normal', weight: 1 },
        { type: 'tough', weight: 3 },
        { type: 'swift', weight: 3 },
      ...
      duration: 132000, clearScore: 28000,
      midboss: { name: '闇の番兵', hp: 280 },
      boss: { name: '暗黒星雲の魔王', pattern: 'nebula', hp: 1180, fireMs: 1300, speed: 50, ways: 2 },
    },
    {
      name: '星の核', bgTheme: 'core',
      enemySpeed: 205, spawnMs: 360,
      enemyFireMs: 640, enemyFireCount: 4, enemyBulletSpeed: 270,
      enemyMix: [
        { type: 'normal', weight: 1 },
        { type: 'tough', weight: 3 },
        { type: 'swift', weight: 3 },
      ...
      duration: 138000, clearScore: 30000,
      midboss: { name: '星の番兵', hp: 320 },
      // 最終ボス：体力が減るごとに攻撃が変わる（3段階）。ways は墨の輪の数、arms は渦巻きの腕の数。
      boss: { name: '星の核', pattern: 'final', hp: 1400, fireMs: 1000, speed: 50, ways: 8, arms: 2 },
    },
  ],
